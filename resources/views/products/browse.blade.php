        ...
        <div class="container-fluid">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div id="batchDelete" class="category-table product-list order-table"></div>
...
<script>
    ...
    $(document).on('click', '.delete-product', function(e) {
        ...
        var $deleteModal = $('#deleteProduct')
        $deleteModal.modal('show')

        $('#product-delete-submit').on('click', function(e) {
            e.preventDefault()
            var deleteUrl = 'product/' + dataId,
